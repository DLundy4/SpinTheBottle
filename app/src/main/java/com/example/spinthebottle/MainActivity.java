                ...
                rotateBottle.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        if (theSpinDegrees % 360 < 90){
                            ...
                            Toast.makeText(MainActivity.this, "The person to the NE has been chosen " + theSpinDegrees % 360, Toast.LENGTH_SHORT).show();
                        } else if (theSpinDegrees % 360 < 180){
                            //right has been chosen
                            Toast.makeText(MainActivity.this, "The person to the SE has been chosen " + theSpinDegrees % 360, Toast.LENGTH_SHORT).show();
                        }
                        else if (theSpinDegrees % 360 < 270){
                            //right has been chosen
                            Toast.makeText(MainActivity.this, "The person to the SW has been chosen " + theSpinDegrees % 360, Toast.LENGTH_SHORT).show();
                        }
                        else {
                            //right has been chosen
                            Toast.makeText(MainActivity.this, "The person to the NW has been chosen " + theSpinDegrees % 360, Toast.LENGTH_SHORT).show();
                        }
                    }
